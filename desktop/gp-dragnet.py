...
class DragnetApp(GhostPortApp):
    ...
    HELP_SECTIONS = [
        ...
        ("Gotchas",
         ...
         "• Captures auto-stop at your packet Limit (default 500), 10 minutes "
         "elapsed, or 100 MB pcap — whichever fires first. tshark has documented "
         "memory leaks on long runs, so the duration cap is a safety net.\n\n"
